...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Future sendCircular() async {
    ...
    var data = {'body': widget.value.body, 'heading':widget.value.heading,'short':widget.value.short, };
...
class _NewState extends State<New> {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: AppBar(title: Text('CIRCULARS', style: TextStyle(color: Colors.white),),backgroundColor: Colors.red,),
        body: new Center(
